...
var kwcontent=[
    ...
    '           </div>' +
    '            <div class="desc">' +
    '                <div class="pur" style="font-weight: 700; font-size: 15px;">행정실, 건축공학과</div>' +
    ...
    },
    {
        ...
        '           </div>' +
        '            <div class="desc">' +
        '                <div class="pur" style="font-weight: 700; font-size: 15px;">소프트웨어융합 대학</div>' +
    
        '                <div><a href="pages/새빛관.html" class="kwbtn" target="_blank">안내 페이지</a></div>' +
        '                <div><a href="pages/소프트웨어_졸업요건.html" class="kwbtn" target="_blank">졸업요건</a></div>' +                 
    ...
    },
    {
        ...
        '           </div>' +
        '            <div class="desc">' +
        '                <div class="pur" style="font-weight: 700; font-size: 15px;">도서관, 식당가</div>' +
...
var kwside=[
    ...
    },
    {
        scon :  '<div class="infosidebar">' +
                ...
                '<span>' + '주소: 서울 노원구 광운로 20' + '</span>'+'<br>'+
                '<span>' + '도서관, 우체국, 푸드코트,프린트,강당' + '</span>'+'<br>' +
                '</div>'
    },
    {
        scon :  '<div class="infosidebar">' +
